...
function PaginaTagNavegacion() {
  ...
  return (
    <>
      <Header />
      <BreadCrumbArea
        nombreseccion={breadCrumb}
        breadCrumbData={breadCrumbData}
        imagen={breadCrumbImagen}
      />
      <FormularioTagNavegacion
        actualizarBreadCrumb={actualizarBreadCrumb}
        actualizarBreadCrumbData={actualizarBreadCrumbData}
        actualizarBreadCrumbImagen={actualizarBreadCrumbImagen}
      />
      <FooterArea />
    </>
  );
