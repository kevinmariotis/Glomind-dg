                    ...
                    <div className="col-lg-3 responsive-column-half">
                        <div className="footer-item">
                            ...
                            <div className="mobile-app">
                                ...
                                <a href="#" className="d-block mb-2 hover-s"><img src={`${urlBase}/images/appstore.png`} alt="App store" className="img-fluid" /></a>
                                <a href="#" className="d-block hover-s"><img src={`${urlBase}/images/googleplay.png`} alt="Google play store" className="img-fluid" /></a>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-3 responsive-column-half">
