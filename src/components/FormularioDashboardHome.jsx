...
function FormularioDashboardHome() {
  return (
        ...
        <div className="container-fluid">
            ...
            <div className="row">
                <div className="col-lg-4 responsive-column-half">
                    <div className="card card-item dashboard-info-card">
                        <div className="card-body d-flex align-items-center">
                            ...
                            <svg class="svg-icon-color-white" width="40" version="1.0" x="0" y="0" viewBox="0 0 512 512">
                                    <g>
                    ...
                    <div className="card card-item dashboard-info-card">
                        <div className="card-body d-flex align-items-center">
                            <div className="icon-element flex-shrink-0 bg-2 text-white">
                                <svg className="svg-icon-color-white" width="40" version="1.0" x="0" y="0" viewBox="0 0 512 512">
                                        <g>
                                            <g>
                                                <g>
                    ...
                    <div className="card card-item dashboard-info-card">
                        <div className="card-body d-flex align-items-center">
                            <div className="icon-element flex-shrink-0 bg-3 text-white">
                                <svg className="svg-icon-color-white" width="40" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512">
                                        <g>
                                            <g>
                                                <g>
                                                    <path d="M405.333,42.667h-44.632c-4.418-12.389-16.147-21.333-30.035-21.333h-32.229C288.417,8.042,272.667,0,256,0
                    ...
                    <div className="card card-item dashboard-info-card">
                        <div className="card-body d-flex align-items-center">
                            <div className="icon-element flex-shrink-0 bg-4 text-white">
                                <svg className="svg-icon-color-white" width="40" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 490.667 490.667">
                                        <g>
                                            <g>
                    ...
                    <div className="card card-item dashboard-info-card">
                        <div className="card-body d-flex align-items-center">
                            <div className="icon-element flex-shrink-0 bg-5 text-white">
                                <svg className="svg-icon-color-white" width="40" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 512 512">
                                        <g>
                                            <g>
                                                <g>
                                                    <path d="M405.333,42.667h-44.632c-4.418-12.389-16.147-21.333-30.035-21.333h-32.229C288.417,8.042,272.667,0,256,0
                ...
                <div className="col-lg-4">
                    <div className="card card-item">
                        <div className="card-body">
                            <h3 className="fs-18 font-weight-semi-bold pb-4">Earning by Location</h3>
                            <div className="my-course-progress-bar-wrap">
                                <div className="d-flex flex-wrap align-items-center mb-2 position-relative">
                                    ...
                                    <div className="skillbar-box">
                                        <div className="skillbar skillbar-skillbar-2" data-percent="80%">
                                ...
                                <div className="d-flex flex-wrap align-items-center mb-2 position-relative">
                                    ...
                                    <div className="skillbar-box">
                                        <div className="skillbar skillbar-skillbar-2" data-percent="70%">
                                ...
                                <div className="d-flex flex-wrap align-items-center mb-2 position-relative">
                                    ...
                                    <div className="skillbar-box">
                                        <div className="skillbar skillbar-skillbar-2" data-percent="60%">
                                ...
                                <div className="d-flex flex-wrap align-items-center mb-2 position-relative">
                                    ...
                                    <div className="skillbar-box">
                                        <div className="skillbar skillbar-skillbar-2" data-percent="50%">
                                ...
                                <div className="d-flex flex-wrap align-items-center mb-2 position-relative">
                                    ...
                                    <div className="skillbar-box">
                                        <div className="skillbar skillbar-skillbar-2" data-percent="40%">
                                ...
                                <div className="d-flex flex-wrap align-items-center mb-2 position-relative">
                                    ...
                                    <div className="skillbar-box">
                                        <div className="skillbar skillbar-skillbar-2" data-percent="30%">
                                ...
                                <div className="d-flex flex-wrap align-items-center mb-2 position-relative">
                                    ...
                                    <div className="skillbar-box">
                                        <div className="skillbar skillbar-skillbar-2" data-percent="20%">
                    ...
                    <div className="card card-item">
                        <div className="card-body">
                            <div className="d-flex justify-content-between align-items-center pb-4">
                                <h3 className="fs-18 font-weight-semi-bold pb-4">Earning Statistics</h3>
                        ...
                        <div className="card-body">
                            ...
                            <div className="notification-body scrolled-box custom-scrollbar-styled">
                                ...
                                <a href="dashboard.html" className="media media-card align-items-center">
                                    ...
                                    <div className="media-body">
                                        <h5 className="fs-15">Your account has been created successfully</h5>
                                        <span className="d-block lh-18 pt-1 text-gray fs-13">November 12, 2019</span>
                                    </div>
                                </a>
                                <a href="dashboard.html" className="media media-card align-items-center">
                                ...
                                <a href="dashboard.html" className="media media-card align-items-center">
                                    ...
                                    <div className="media-body">
                                        <h5 className="fs-15">You applied for a job Front-end Developer</h5>
                                        <span className="d-block lh-18 pt-1 text-gray fs-13">November 12, 2019</span>
                                    </div>
                                </a>
                                <a href="dashboard.html" className="media media-card align-items-center">
...
export default FormularioDashboardHome;