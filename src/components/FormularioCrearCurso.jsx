...
function FormularioCrearCurso() {
    ...
    const handleCrearCurso = async (event) => {
        ...
        formData.append('compartir_empresas', 0);   
        ...
        formData.append('idiomas', 'es');        
        formData.append('expedir_certificado', expedirCerfificado);
        formData.append('nota_minima_superado', notaMinimaSuperado);        
        formData.append('desc_general', descripcion);                
        ...
        formData.append('id_video_grande', '0');
        formData.append('id_video_pequeno', '0');
        ...
        formData.append('desc_que_aprenderas', queaprenderasx);        
        ...
        try {
            ...
            if (response.ok){  
               ...
               setPopup({mostrar:true, titulo:'Listo', contenido:'Curso creado satisfactoriamente'});
                return;
            } else {
            ...
            <div className="container-fluid">
                ...
                <form action="#">
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="form-group">
                                        ...
                                        <input onChange={handleNombreChange} className="form-control form--control pl-3" type="text" name="nombre" maxLength="128" placeholder="Ej: Curso de React Avanzado" />
                                ...
                                <div className="col-lg-6">
                                    <div className="form-group">
                                        ...
                                        <input onChange={handleCodigoChange} className="form-control form--control pl-3" type="text" name="codigo" maxLength="32" placeholder="Ej: 25T56-20231" />
                        ...
                        <div className="card-body">
                            ...
                            <div className="col-lg-6">
                                    <div className="form-group">
                                        ...
                                        <input onChange={handlePrecioActualChange} className="form-control form--control pl-3" type="text" name="precio_actual" maxLength="8" placeholder="Ej: 123000" />
                                ...
                                <div className="col-lg-6">
                                    <div className="form-group">
                                        ...
                                        <input onChange={handlePrecioAnteriorChange} className="form-control form--control tags-input" type="text" name="precio_anterior" maxLength="8" placeholder="Ej: 170000" />
                                ...
                                <div className="col-lg-6">
                                    <div className="form-group">
                                        ...
                                        <input onChange={handlePrecioAdicionalExamenesChange} className="form-control form--control tags-input" type="text" name="precio_adicional_examenes" maxLength="8" placeholder="Ej: 90000" />
                                ...
                                <div className="col-lg-6">
                                    <div className="form-group">
                                        ...
                                        <input onChange={handlePrecioAdicionalCertificadoChange} className="form-control form--control tags-input" type="text" name="precio_adicional_certificado" maxLength="8" placeholder="Ej: 90000" />
                            ...
                            <div className="row">                                
                                <div className="col-lg-12">
                                    <div className="form-group">
                                        ...
                                        <textarea onChange={handleDescripcionChange} className="form-control form--control user-text-editor pl-3" name="desc_general"></textarea>
                    ...
                    <div className="course-submit-btn-box pb-4">
                        <button className="btn theme-btn" type="submit" onClick={handleCrearCurso}>Crear curso</button>
                    </div>
                </form>
            </div>
        </div>
