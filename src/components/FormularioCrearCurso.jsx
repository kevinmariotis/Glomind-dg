...
function FormularioCrearCurso() {
  ...
  const handleCrearCurso = async (event) => {
    ...
    formData.append(
      "id_instructor",
      instructorSeleccionado != null ? instructorSeleccionado.value : 0
    );
    formData.append(
      "id_certificado",
    ...
    formData.append("area_de_formacion", area_de_formacionx);
    ...
    formData.append("fines_de_aprendizaje", fines_de_aprendizajex);
    ...
    formData.append("proposito_del_curso", proposito_del_cursox);
    ...
    try {
      ...
      if (response.ok) {
        ...
        setPopup({
          mostrar: true,
          titulo: "Listo",
          contenido: "Curso creado satisfactoriamente",
        });
        return;
      } else {
        mensajesDeError(
