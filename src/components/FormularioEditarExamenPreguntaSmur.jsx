        ...
        if (response.ok) {
          if (datos2.pregunta.id_examen == id) {
            ...
            datos2.opciones.forEach(function (element) {
              ...
              nuevas_opciones.push({
                id: element.id,
                respuesta: desc,
                porcentaje: element.porcentaje_puntuacion,
              });
            });
          ...
          <div className="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between mb-3">
            ...
            <div className="media media-card align-items-center theme-title mt-3">
              <h3 className="fs-22 font-weight-semi-bold">
                Editar pregunta de selección múltiple con única respuesta
              </h3>
              <h5>&nbsp;|&nbsp;{nombreexamen}</h5>
            </div>
          ...
          <form action="#">
            ...
            <div className="card-theme mt-3">
              <div className="card-body">
                ...
                {erroresCampos["error_general"].length > 0 && (
                  <SpamError mensaje={erroresCampos["error_general"]} />
                )}
