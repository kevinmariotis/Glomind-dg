...
function VideoPlayerPrisma({
  url_video = "",
  url_imagen_preview = "",
  mostrar_controles = true,
  posision_actual = 0,
  estado_consumo = 0,
  funcion_reportar_posicion_actual = false,
  funcion_reportar_visto_completo = false,
}) {
  ...
  const [posicionActualEstablecida, setPosicionActualEstablecida] =
    useState(false);
  const [preguntarContinuar, setPreguntarContinuar] = useState(false);
  const [iniciarDesdeUltimaPosicion, setIniciarDesdeUltimaPosicion] =
    useState(false);
  ...
  const handleOnStart = () => {
    if (
      posision_actual != 0 &&
      isPlaying === true &&
      posicionActualEstablecida === false &&
      iniciarDesdeUltimaPosicion
    ) {
    ...
    <>
      ...
      {controlsVisible && (
        <>
          ...
          <div
            className="area-button fullscreen-area"
            ...
            <div className="modal-content">
              ...
              <div className="modal-footer border-top-gray">
                <button
                  ...
                  onClick={handleContinuarUltimaPosicion}
                >
                  Claro que si
                </button>
                <button
