...
function FormularioHome() {        
    ...
    const [cantidadEstudiantesMatriculados, setCantidadEstudiantesMatriculados] = useState(0);    
    const [cantidadCursosDisponibles, setCantidadCursosDisponibles] = useState(0);    
    const [certificadoExpedidos, setCertificadosExpedidos] = useState(0);    
    ...
    const obtenerDatosDelServidor = async () => {                  
        ...
        try {            
            ...
            if (response.ok){                                                                               
                ...
                setCantidadDocentes(datos.cantidad_docentes);
                setCantidadEstudiantesMatriculados(datos.cantidad_estudiantes);
                setCantidadCursosDisponibles(datos.cantidad_cursos)
                setCertificadosExpedidos(datos.certificados_expedidos);
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-3 responsive-column-half">
                            <div className="counter-item">
                                <div className="counter__icon icon-element mb-3 shadow-sm">
                                    <i className="la la-book mr-1 text-color-3"></i>
                                </div>
                                <h4 className="counter__title counter text-color-3">{cantidadCursosDisponibles}</h4>
                                <p className="counter__meta">Cursos disponibles</p>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 responsive-column-half">
                            <div className="counter-item">
                                <div className="counter__icon icon-element mb-3 shadow-sm">
                                    <svg className="svg-icon-color-3" width="42" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 490.667 490.667" xmlSpace="preserve" > <g> <g> <path d="M245.333,85.333c-41.173,0-74.667,33.493-74.667,74.667s33.493,74.667,74.667,74.667S320,201.173,320,160C320,118.827,286.507,85.333,245.333,85.333z M245.333,213.333C215.936,213.333,192,189.397,192,160c0-29.397,23.936-53.333,53.333-53.333s53.333,23.936,53.333,53.333S274.731,213.333,245.333,213.333z"></path> </g> </g> <g> <g> <path d="M394.667,170.667c-29.397,0-53.333,23.936-53.333,53.333s23.936,53.333,53.333,53.333S448,253.397,448,224S424.064,170.667,394.667,170.667z M394.667,256c-17.643,0-32-14.357-32-32c0-17.643,14.357-32,32-32s32,14.357,32,32C426.667,241.643,412.309,256,394.667,256z"></path> </g> </g> <g> <g> <path d="M97.515,170.667c-29.419,0-53.333,23.936-53.333,53.333s23.936,53.333,53.333,53.333s53.333-23.936,53.333-53.333S126.933,170.667,97.515,170.667z M97.515,256c-17.643,0-32-14.357-32-32c0-17.643,14.357-32,32-32c17.643,0,32,14.357,32,32C129.515,241.643,115.157,256,97.515,256z"></path> </g> </g> <g> <g> <path d="M245.333,256c-76.459,0-138.667,62.208-138.667,138.667c0,5.888,4.779,10.667,10.667,10.667S128,400.555,128,394.667c0-64.704,52.629-117.333,117.333-117.333s117.333,52.629,117.333,117.333c0,5.888,4.779,10.667,10.667,10.667c5.888,0,10.667-4.779,10.667-10.667C384,318.208,321.792,256,245.333,256z"></path> </g> </g> <g> <g> <path d="M394.667,298.667c-17.557,0-34.752,4.8-49.728,13.867c-5.013,3.072-6.635,9.621-3.584,14.656c3.093,5.035,9.621,6.635,14.656,3.584C367.637,323.712,380.992,320,394.667,320c41.173,0,74.667,33.493,74.667,74.667c0,5.888,4.779,10.667,10.667,10.667c5.888,0,10.667-4.779,10.667-10.667C490.667,341.739,447.595,298.667,394.667,298.667z"></path> </g> </g> <g> <g> <path d="M145.707,312.512c-14.955-9.045-32.149-13.845-49.707-13.845c-52.928,0-96,43.072-96,96c0,5.888,4.779,10.667,10.667,10.667s10.667-4.779,10.667-10.667C21.333,353.493,54.827,320,96,320c13.675,0,27.029,3.712,38.635,10.752c5.013,3.051,11.584,1.451,14.656-3.584C152.363,322.133,150.741,315.584,145.707,312.512z"></path> </g> </g> </svg>
                                </div>
                                <h4 className="counter__title counter text-color-4">{cantidadEstudiantesMatriculados}</h4>
                                <p className="counter__meta">Estudiantes Matriculados</p>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6">
                            <div className="about-content pb-5">
                                <div className="section-heading">
                                    ...
                                    <h2 className="section__title">Beneficios de aprender con Prizma</h2>
                                    <span className="section-divider"></span>
                                    <p className="section__desc">
                                        La flexibilidad en cuanto a horarios, permite a los estudiantes adaptar su aprendizaje a sus compromisos existentes. 
                                        La diversidad de cursos disponibles abarca una amplia gama de temas, permitiendo a los estudiantes elegir aquellos que mejor se alineen con sus intereses y metas profesionales.
                                    </p>
                                </div>
                                <div className="row pt-4 pb-3">
                                    ...
                                    <div className="col-lg-4 responsive-column-half">
                                        <div className="info-icon-box mb-3">
                                            ...
                                            <h4 className="fs-20 font-weight-semi-bold pt-3">Instructores expertos</h4>
                                        </div>
                                    </div>
                                </div>
                                <div className="btn-box" style={{display:'none'}}>
                                    <a href="#" className="btn theme-btn">Learn More <i className="la la-arrow-right icon ml-1"></i></a>
                                </div>
                            </div>
                        </div>
            ...
            <section class="client-logo-area section-padding position-relative overflow-hidden text-center">
                ...
                <div class="container">
                    <div class="section-heading">
                        ...
                        <h2 class="section__title">Las mejores empresas eligen <span class="text-color">Prizma</span> para construir sus
