  ...
  const obtenerDatosServidor = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        let ruta_archivo =
          urlBaseApi + "/" + datos.ruta_archivo.replace("public/", "");
  ...
  return (
    <>
      ...
      <div style={fileType == "pdf" ? style_pdf : style_nopdf}>
        ...
        {(fileType != "pdf" || (fileType == "pdf" && esMovil)) &&
          fileType != "jpg" &&
          fileType != "jpeg" &&
          fileType != "png" && (
            <div style={{ marginBottom: "300px", marginTop: "150px" }}>
              <div style={{ marginBottom: "10px" }}>
                El archivo no se puede abrir en el navegador
              </div>
              <button
        ...
        {fileType != "pdf" &&
          (fileType == "jpg" || fileType == "jpeg" || fileType == "png") && (
            <div>
              <img src={rutaArchivo} className="img-fluid m-3" />
            </div>
          )}
      </div>
    </>
