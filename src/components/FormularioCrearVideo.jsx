...
function FormularioCrearVideo() {
  ...
  const handleSubirVideo = async (event) => {
    ...
    if (selectedVideo != null) {
      ...
      formData.append("id_video_tipo", tipo);
      ...
      xhr.onload = () => {
        ...
        if (status >= 200 && status < 300) {
          setPopup({
            mostrar: true,
            titulo: "Listo",
            contenido: "Video guardado satisfactoriamente",
            data_switch: "video-creado",
          });
          setNombre("");
          setDescripcion("");
        } else {
          ...
          <div className="dashboard-heading mb-5">
            <h3 className="fs-22 font-weight-semi-bold">
              <Link
                to={
                  id_curso_agregar
                    ? `/curso/contenido/${id_curso_agregar}`
                    : `/video`
                }
              >
                <div
                    ...
                    <div className="form-group mb-0">
                      <div {...getRootProps()}>
                        ...
                        <span className="file-upload-text">
                          ...
                          Seleccona o arrastra el video aquí.
                        </span>
                      </div>
                      <ul>{fileList}</ul>
