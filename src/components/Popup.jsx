...
/*
    ...
    */
function Popup({mostrarPopup=false, tamano="lg", tipo=2, titulo="", mensaje="", funcionAceptar=()=>{}, funcionCerrar=()=>{}, textoCerrar="Cerrar", textoAceptar="Aceptar", textoTercerBoton="", funcionTercerBoton=()=>{}}){
    ...
    return (<Modal className='modal-theme' show={mostrarPopup} size={tamano} onHide={handleFuncionCerrar} backdrop="static" keyboard={false} animation={false} centered>
                ...
                <Modal.Footer>
                    ...
                    {(textoTercerBoton!='') && <Button variant="secondary" onClick={handleFuncionTercerBoton}>{textoTercerBoton}</Button>}
                    {(tipo==1 || tipo==3) && <Button variant="secondary" onClick={handleFuncionCerrar}>{textoCerrar}</Button>}                    
                </Modal.Footer>
            </Modal>);
}
