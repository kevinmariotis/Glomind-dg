  ...
  const enviarCorreoElectronico = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${urlBaseApi}/api/usuario/enviarEmailRecuperarCuenta/1`,
        opcionesx
      );
      ...
      if (response.ok) {
        setPopup({
          ...
          titulo: "Listo",
          contenido:
            "Si la cuenta proporcionada " +
            username +
            " está registrada en nuestro sistema, se le acaba de enviar un correo electrónico para el reestablecimiento de su contraseña.",
        });
        ...
        mensajesDeError(
          ...
          setErrorCampoGlobal,
          { titulo: "Error", contenido: "Revise los errores en el formulario." }
        );
        setResetKey((prevKey) => prevKey + 1);
      }
    } catch (error) {
  ...
  const restablecerContrasena = async () => {
    ...
    if (nuevaContrasena == repetirNuevaContrasena) {
      ...
      try {
        setMostrarSpinner(true);
        const response = await fetch(
          `${urlBaseApi}/api/usuario/recuperarCuenta/${id_usuario}`,
          opciones
        );
        setMostrarSpinner(false);
        const datos = await response.json();
        if (response.ok) {
          setPopup({
            ...
            titulo: "Listo",
            contenido:
              "Cambios guardados correctamente, ahora puedes inciar sesión.",
            data_switch: "contrasena-cambiada",
          });
        } else {
          mensajesDeError(
            setPopup,
      ...
      setPopup({
        mostrar: true,
        titulo: "Contraseñas no coincicden",
        contenido:
          "Asegúrate de haber escrito bien la contraseña y la repetición.",
      });
    }
  };
            ...
            {id_usuario == undefined ? (
              <div className="card card-item card-round">
                <div className="card-body  p-0">
                  <h3 className="card-title fs-24 lh-35 pb-2">
                    Recuperar cuenta!
                  </h3>
                  <p className="fs-15 lh-24 pb-3">
                    Ingrese el correo electrónico de su cuenta para restablecer
                    la contraseña. Recibirá un enlace por correo electrónico
                  ...
                  <form method="post" className="pt-4">
                    <div className="input-box">
                      ...
                      <div className="form-group">
                        <input
                          ...
                          type="text"
                          name="name"
                          placeholder="Digite el correo electrónico de la cuenta"
                        />
                    ...
                    <div className="btn-box">
                      <button
                        ...
                        type="button"
                      >
                        Enviarme correo electrónico{" "}
                        <i className="la la-arrow-right icon ml-1"></i>
                      </button>
                      <div className="fs-14 pt-2 mt-2">
                        <p>
              ...
              <div className="card card-item">
                <div className="card-body">
                  ...
                  <p className="fs-15 lh-24 pb-3">
                    Si el link de recuperación es válido se le reestablecerá su
                    contraseña.
                  </p>
                  ...
                  <form method="post" className="pt-4">
                    ...
                    <div className="input-box">
                      ...
                      <div className="form-group">
                        <input
                          onChange={handleRepetirNuevaContrasena}
                          value={repetirNuevaContrasena}
                          className="form-control form--control"
                          type="password"
                          name="repetir_nueva_contrasena"
                          placeholder=""
                        />
                        <span className="la la-user input-icon"></span>
                      </div>
