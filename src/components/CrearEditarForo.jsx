...
export default function CrearEditarForo({
  funcionMostrarPopUp,
  id_curso,
  id_categoria,
  id_foro = -1,
  ...
  const handleObjeto = {
    ...
    modo_calificacion: (event) => {
      setDatos({ ...datos, modo_calificacion: event.target.value });
    },
    ...
    get: async (event) => {
      ...
      try {
        ...
        const response = await fetch(
          `${urlBaseApi}/api/foro/${id_foro}/${id_curso}`,
          opciones
        );
        ...
        if (response.ok) {
          ...
          const modo_calificacion =
            datos.modo_calificacion == 1 ? "mas_alta" : "promedio";
            ...
            <div className="modal-header border-bottom-gray">
              <div className="pr-2">
                <h5
                  ...
                  id="tagModalTitle"
                >
                  {id_foro != -1 ? "Editar foro" : "Crear foro"}
                </h5>
              </div>
            </div>
            <div className="modal-body">
              ...
              <div className="col-lg-12">
                <div className="form-group">
                  ...
                  <select
                    onChange={handleObjeto.modo_calificacion}
                    style={{ height: "50px" }}
                    value={datos.modo_calificacion}
                    name="modo_calificacion"
                    className={`form-control ${
                      temaActual == 1 ? "" : "select-dark"
                    }`}
                  >
                  ...
                  {erroresCampos["modo_calificacion"].length > 0 && (
                    <SpamError mensaje={erroresCampos["modo_calificacion"]} />
                  )}
                </div>
              </div>
              <div className="col-lg-12">
