                            ...
                            <div className="card-body">
                                ...
                                <div className="d-flex justify-content-between align-items-center">
                                    ...
                                    <div className="card-action-wrap pl-3">
                                        {permissions[20] ? <Link to={`/play/${cursos[key].url_amigable}`} className="icon-element icon-element-sm shadow-sm cursor-pointer ml-1 text-success" data-toggle="tooltip" data-placement="top" data-title="View"><i className="la la-eye"></i></Link> : ''}
