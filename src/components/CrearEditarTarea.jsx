...
export default function CrearEditarTarea({funcionMostrarPopUp, id_curso, id_categoria, id_tarea=-1}) {
    ...
    const handleObjeto = {
        ...
        reenviar_post_calificacion   : (event) => { setDatos({...datos, reenviar_post_calificacion:event.target.value});  },
        ...
        get           : async (event) =>{
            ...
            try {               
                ...
                const response = await fetch(`${urlBaseApi}/api/tarea/${id_tarea}/${id_curso}`, opciones);
        ...
        save          : async (event) => {
            ...
            if(id_tarea != -1){                
                ...
                let resRowData = {
                    ...
                    reenviar_post_calificacion: datos.reenviar_post_calificacion.toString(),
                    id_curso : id_curso,
                ...
                setMostrarSpinner(true);                                                
                const responseRaw = await fetch(`${urlBaseApi}/api/tarea/${id_tarea}`, opcionesData);
                if (responseRaw.ok){                                            
                    setPopup({mostrar:true, titulo:'Listo', contenido:'Tarea guardada.', data_switch:'cerrar_ventana'});
                } else {
                ...
                resData.append('reenviar_post_calificacion', datos.reenviar_post_calificacion);
                ...
                setMostrarSpinner(false);
                if (response.ok){                                            
                    setPopup({mostrar:true, titulo:'Listo', contenido:'Tarea creada.', data_switch:'cerrar_ventana'});
                    return;
                } else {
                    const datos = await response.json();
            ...
            <div className="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div className="modal-content">
                    <div className="modal-header border-bottom-gray">
                        <div className="pr-2">                            
                            <h5 className="modal-title fs-19 font-weight-semi-bold lh-24" id="tagModalTitle">{id_tarea!=-1 ? 'Editar Tarea' : 'Crear Tarea' }</h5>
                        </div>                            
                    </div>
                    <div className="modal-body">
                        ...
                        <div className="col-lg-12">
                            <div className="form-group">
                                ...
                                {erroresCampos['reenviar_post_calificacion'].length > 0 && (<SpamError mensaje={erroresCampos['reenviar_post_calificacion']} />)}
                            </div>
                        </div>
                        <div className="col-lg-12">
                            <div className="form-group">
                    ...
                    <div className="modal-footer border-top-gray">
                        <button type="button" className="btn theme-btn mb-2" onClick={handleObjeto.save} >{id_tarea != -1 ? 'Guardar' : 'Crear'}</button>                             
