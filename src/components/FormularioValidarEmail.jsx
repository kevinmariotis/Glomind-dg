...
function FormularioValidarEmail() {        
    ...
    const obtenerDatosDelServidor = async () => {                  
        ...
        try {            
            ...
            const response = await fetch(`${urlBaseApi}/api/usuario/validaremail/${id_usuario}/${hash}`, opciones);
            setMostrarSpinner(false);
            const datos = await response.json();
            if (response.ok){
                setEstadoBusqueda(1);                
            } else {
                if(datos.codigo!='validado-previamente'){
                    setEstadoBusqueda(2);                
                ...
                <div className="container">
                    <div className="col-lg-7 mx-auto">
                            ...
                            <div className="error-content text-center">                            
                                ...
                                <div className="section-heading">
                                    <h3 className="section__title pb-3">
                                        {estadoBusqueda==-1 ? 'Validando correo electrónico...'
                                        : estadoBusqueda==1 ? 
                                            'Correo electrónico validado, ya puedes iniciar sesión'
                                        :
                                            'Link de validación de correo electrónico expirado o inválido'
                                        }
                                    </h3>                                
                                    <p className="section__desc">
                                        Este paso agrega seguridad adicional a su cuenta al verificar que es el propietario de este correo electrónico.
                                    </p>
                                </div>
                        ...
                        : 
                            <div className="error-content text-center">
                                <div className="section-heading">
                                    <h3 className="section__title pb-3">Un paso más</h3>
                                    <p className="section__desc">
                                        Antes de entrar a la cuenta debes validar tu correo electrónico, busca un mensaje que te enviamos a {hash} y presiona en "Confirmar email".
                                    </p>
                                </div>
                            </div>
                        }
...
export default FormularioValidarEmail;